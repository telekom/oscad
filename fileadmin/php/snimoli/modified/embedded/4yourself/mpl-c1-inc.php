...
$gFbLiSpUcName="MPL-C1";

$gFbLiSpUcDesc=
	"that you are going to use a received MPL licensed software only
...
$gFbLiSpUcNoTasks="You are allowed to use any kind of MPL software in any sense and in
