...
<body>
  ...
  <div class="huge box">
    ...
    <p style="text-align:left;">You requested the oscad server with an invalid set of
    parameters concerning the use case specifications:
    ...
    <ul style="text-align:left;">
      <li>RECIPIENT=<?php echo "$gOsucRecipient"?></li>
      <li>TYPE=<?php echo "$gOsucType"?></li>
      <li>STATE=<?php echo "$gOsucState"?></li>
      <li>FORM=<?php echo "$gOsucForm"?></li>
      <li>CONTEXT=<?php echo "$gOsucContext"?></li>
    </ul>
    </p>
    <p style="text-align:left;">
      But OSCAd can only deal with the the following elements:
      <ul style="text-align:left;">
      <?php

      foreach($gAcceptedUcParameters as $parameter=>$allowedValues){
        echo "<li>".htmlspecialchars($parameter)." -> [";
        $second=false;
