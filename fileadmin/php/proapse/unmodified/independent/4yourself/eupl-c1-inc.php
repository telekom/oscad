...
$gFbLiSpUcName="EUPL-C1";

$gFbLiSpUcDesc=
	"that you are going to use a received EUPL licensed software only
...
$gFbLiSpUcNoTasks=
    "You are allowed to use any kind of EUPL software in any sense and in
