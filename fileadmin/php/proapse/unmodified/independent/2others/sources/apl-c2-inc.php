...
$gFbLiSpUcDesc=
	...
	source code package. In this case it is not discriminating
...
$gFbLiSpUcRequiresManArr=array(
	...
	"Ensure that the licensing elements – esp. the specific
	 copyright notice of the original author(s) – are retained 
