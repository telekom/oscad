...
<body>
  ...
  <div class="huge box">
    ...
    <p style="text-align:left;">With respect to the license specification, you requested the
    oscad server with an invalid set of parameters:

    <ul style="text-align:left;">
      <?php

      foreach($gHttpRequestParameters as $key=>$value){
    ...
    <p style="text-align:left;">We tried to match your input as it is shown by the following list:
    <ul style="text-align:left;">
      <li>LICENSE=<?php echo "$gOsucLicense"?></li>
    </ul>
    </p>
    <p style="text-align:left;">
      Mostly, you may assume that the OSCAd backend still does not know
      this license - regardless what your frontend might indicate to
      you. Actually OSCAd can generate license fulfilling task lists for
      the following licenses:
      <ul style="text-align:left;">
      <?php
      foreach($gCoveringUseCaseMatrixArray as $license=>$usList){
        echo "<li>".htmlspecialchars($license)."</li>\n";
      }
      ?>
      </ul>
    </p>
